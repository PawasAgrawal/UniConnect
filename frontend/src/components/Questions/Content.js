...
export default function Content(props) {
    ...
    const fetchQuestion = async (id) => {
        ...
        await fetch(`https://uniconnect-8tk4.onrender.com/api/question/fetchQueById/${id}`, {
            method: "POST",
            headers: {
    ...
    const fetchAnswers = async (id) => {
        await fetch(`https://uniconnect-8tk4.onrender.com/api/answer/fetchanswer/${id}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    const handleSubmit = async (e, id) => {
        ...
        e.preventDefault();
        const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/answer/addanswer/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const upvoteQue = async (e, id) => {
        ...
        if (localStorage.getItem("username") !== null) {
            ...
            const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/question/upvote/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const downvoteQue = async (e, id) => {
        ...
        if (localStorage.getItem("username") !== null) {
            ...
            const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/question/downvote/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const upvote = async (e, id) => {
        ...
        if (localStorage.getItem("username") !== null) {
            ...
            const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/answer/upvote/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const downvote = async (e, id) => {
        ...
        if (localStorage.getItem("username") !== null) {
            ...
            const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/answer/downvote/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const fetchVotes = async () => {
        ...
        const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/answer/fetchVotes`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const fetchQueVotes = async (id) => {
        ...
        const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/question/fetchVotes/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const addComment = async (e, id) => {
        ...
        const response = await fetch(`https://uniconnect-8tk4.onrender.com/api/comment/addcomment/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    const fetchComments = async (id) => {
        await fetch(`https://uniconnect-8tk4.onrender.com/api/comment/fetchComments`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            },
            ...
            <div className="container" Style="height:100vh;width:70%;display:block; margin:auto;">
                ...
                <div className="d-flex flex-row">
                    <div className="d-flex flex-column col-md-0 mt-0 mx-0">
                        <button className='btn btn-white' id="queupvotebtn" onClick={(e) => upvoteQue(e, question._id)} style={{ width: '15px', border: 'none' }}><FontAwesomeIcon icon={faCaretUp} style={{ fontSize: '35px' }} /></button>
                        <div className='mx-3'>{queVote}</div>
                        <button className='btn btn-white' id="quedownvotbtn" onClick={(e) => downvoteQue(e, question._id)} style={{ width: '15px', border: 'none' }}><FontAwesomeIcon icon={faCaretDown} style={{ fontSize: '35px' }} /></button>
                    ...
                    <div className='mt-5'>
                        {answers.map(ans => (
                            <div className="">
                                ...
                                <div className="d-flex flex-row">
                                    <div className="d-flex flex-column col-md-0 mt-0 mx-0">
                                        <button className='btn btn-white' id={"ansupvotebtn" + ans._id} onClick={(e) => upvote(e, ans._id)} Style="width:15px; border:none;"><FontAwesomeIcon icon={faCaretUp} style={{ fontSize: '35px' }} /></button>
                                        <div className='mx-3'>{vote[ans._id]}</div>
                                        <button className='btn btn-white' id = {"ansdownvotebtn" + ans._id} onClick={(e) => downvote(e, ans._id)} Style="width:15px; border:none;"><FontAwesomeIcon icon={faCaretDown} style={{ fontSize: '35px' }} /></button>
                                        {(
                                            () => {
