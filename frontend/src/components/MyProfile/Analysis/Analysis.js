...
export default function Analysis() {
    ...
    useEffect(() => {
        fetch(`https://uniconnect-8tk4.onrender.com/api/question/fetchUserQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`https://uniconnect-8tk4.onrender.com/api/answer/fetchUserAcceptedAnsweredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`https://uniconnect-8tk4.onrender.com/api/answer/fetchUserAnsweredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
